...
import 'package:refreshed_cli/functions/binding/add_dependencies.dart';
import 'package:refreshed_cli/functions/binding/find_bindings.dart';
...
class CreateControllerCommand extends Command {
  ...
  Future<void> createController(String name,
    ...
    var sample = ControllerSample('', name);
